...
<table align="center">
<tr>
<td>Email Id</td><td ><input class="input" placeholder="Email Id" type="text" name="username" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"></td>
</tr>
<tr>
<td>Password</td><td ><input  class="input"  placeholder="Password" type="password" name="password" required></td>
</tr>
<tr>
