...
<body>
 ...
 <center>
  <table class ="card" style="width:100%" >
    ...
    <tr>
      <td colspan="2"><img src="http://localhost:7771/ShopDropImageServer/images/${Product.product_image}" alt="Product Image" height="200" width="130"></td>
      </tr>
      <tr>
 ...
 ${Product.description}
  ...
  <span class="popuptext" id="myPopup">Kindly Login First!</span>
   </div>
   <br>
   <br>
