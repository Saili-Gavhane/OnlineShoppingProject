...
body {font-family: Arial;
	...
	<table>
		<tr><td><b>Card No</b></td><td><input type="number" name="cardNo" value="5555555555555"></td></tr>
		<tr><td><b>CVV</b></td><td><input type="number" name="cvv" value="123"></td></tr>
		<tr><td><b>Issue Date</b></td><td><input type="date" name="issueDate" value="22-02-97"></td></tr>
		<tr><td><b>Expiry Date</b></td><td><input type="date" name="expiryDate" value="22-02-98"></td></tr>
		<tr><td><b>Payee No</b></td><td><input type="number" name="recipentAccountNo" value="1000041"></td></tr>
		<tr><td><b>Amount</b></td><td><input type="text" name="amount" value="${amount}" readonly></td></tr>
</table>
<br>
<br>
